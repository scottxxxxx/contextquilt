...
``"Sai/Santosh"`` on commitment patches and created one synthetic person
...
to the live enforcer, so any new compound owner ("Srikanth/Ella") is now
...
the dashboard a person card titled "Sai/Santosh" reads as one entity.
...
# whitespace around the slash so "Chantelle / John" matches as well as
# "Sai/Santosh".
