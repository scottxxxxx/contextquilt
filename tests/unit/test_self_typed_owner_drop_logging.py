...
a genuine third-party attribution ("Joe prefers to avoid continuous
...
class TestBehaviourIsUnchanged:
    ...
    def test_action_types_untouched(self):
        ...
        c = {"patches": [_p("commitment", "ship it", "Joe")]}
        strip_owner_on_self_typed_patches(c, user_label="Scott")
        assert c["patches"][0]["value"]["owner"] == "Joe"
...
class TestClassification:
    ...
    def test_real_third_party_is_flagged(self):
        ...
        assert r["third_party_detail"][0]["owner"] == "Joe"
    ...
    def test_the_prod_mix_reproduces(self):
        ...
        patches = (
            ...
            + [_p("preference", "You prefer to close integration work", "Rashmi")]
            + [_p("preference", "Joe prefers fewer upgrades", "Joe"),
               _p("preference", "Joe prefers stability", "Joe")]
        )
        c = {"patches": patches}
        strip_owner_on_self_typed_patches(c, user_label="Scott")
        r = _report(c)
        # The corrupt one classifies as third party: 'Rashmi' is a real
...
class TestQuietWhenNothingHappens:
    ...
    def test_detail_text_is_truncated(self):
        c = {"patches": [_p("preference", "x" * 500, "Joe")]}
        strip_owner_on_self_typed_patches(c, user_label="Scott")
