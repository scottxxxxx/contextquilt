...
The production date is June 28, 2026. Scott will reach out to Arvind regarding Nova 3."""

# Case 2: Podcast / content discussion (should NOT extract projects)
PODCAST_DISCUSSION = """True Crime Podcast Review - Mar 25, 2026

Scott and his friend Cranmore were catching up and discussing recent podcast episodes they'd been listening to.
...
Cranmore recommended another podcast about The Vanishing at Lake Mead — a series about three hikers who disappeared in 2019. "It's really well produced, reminds me of Serial season one."

They also talked about a documentary series on the Enron scandal called The Smartest Guys in the Room. Scott said he'd already seen it but Cranmore was just getting into it.
...
Cranmore suggested they do a joint episode about how they use AI tools at work. Scott said he'd think about it."""
...
CASUAL_MEETING = """Coffee Chat with Lockridge - Mar 27, 2026

Scott had a casual coffee chat with his colleague Lockridge from the marketing team.

Lockridge mentioned she's been overwhelmed with the rebrand launch. "We're juggling the website redesign, new brand guidelines, and the launch event all at once."

Scott offered to help review the technical sections of the new website copy. Lockridge appreciated it and said she'd send him the draft by Wednesday.

They talked about the company offsite next month. Lockridge is organizing it and needs headcount by Friday. Scott said he'd confirm his attendance today.

They also chatted about a book Lockridge recommended — Thinking in Systems by Donella Meadows. Scott said he'd add it to his reading list.

Scott mentioned he's been experimenting with using Claude for meeting notes. Lockridge was curious and asked for a demo sometime next week."""
...
TEST_CASES = {
    ...
    "casual": {
        ...
        "description": "Casual chat — might extract rebrand as project (Lockridge owns it, not Scott)",
    },
}
