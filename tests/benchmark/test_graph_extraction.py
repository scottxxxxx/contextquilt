...
Rules:
1. Entity names must be exact as mentioned (e.g., "Bramble Martinez" not "Bramble")
...
Attendees: Lockridge Chen (Tech Lead), Bramble Martinez (VP Product)

Lockridge opened by confirming that Acme Corp signed the renewal with a June 15 deadline for real-time collaboration — it's a contractual obligation.

Bramble said he's been evaluating the WebSocket infrastructure and estimates a working prototype in three weeks. He flagged that Tom's user research shows 40% of target users have unreliable internet, making offline mode critical.

Lockridge proposed shipping offline mode as core and real-time collab as beta. She asked Bramble to have the WebSocket prototype ready by April 5th, and said she'd schedule a demo with Acme's CTO David Chen the following week.

Bramble agreed to April 5th but needs staging environment access — asked Lockridge to submit the request today. He also noted the project budget is capped at $150,000 per Lisa from finance.
