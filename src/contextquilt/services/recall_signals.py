...
context block:
  ...
  (no stored memory about: Kinsley, Falcon Redesign)
...
memory about Lockridge)" when the index knows "Lockridge Abrams" is worse
...
_STOPWORDS = {
    ...
    # Imperative/request verbs that lead runs like "Ask Kinsley" or
