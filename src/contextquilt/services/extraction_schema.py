...
def enforce_owner_edge_agreement(
    ...
    for new non-prod environment; coordinate with Pradeep on turnaround
    time" carried owns edges from BOTH Pradeep, the real owner, and
    Jayanth, whose actual role was supplying the IP address the work waits
    ...
    Conservative by construction:
      - An action item with no usable stated owner is left completely
        ...
        the patch has.
      - Compound owners ("Srikanth/Ella") keep every edge, using the same
