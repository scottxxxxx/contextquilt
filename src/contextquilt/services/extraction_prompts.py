...
- If someone is introduced as "Bramble Martinez" and later referred to as just "Bramble", always use "Bramble Martinez"
...
- YES: "Quinby owns the search pipeline rewrite" — role/responsibility
