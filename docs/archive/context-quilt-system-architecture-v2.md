...
**Example Use Case:**
```
User: "Show me the notes from my last meeting with Corwin"
...
**Example: "What did I discuss with Corwin in our last meeting?"**

```
┌─────────────────────────────────────────────────────────────────┐
│ User Query: "What did I discuss with Corwin in our last meeting?" │
└────────────────────────────┬────────────────────────────────────┘
                             │
                             ▼
┌─────────────────────────────────────────────────────────────────┐
...
│  (p:Person {name:'Corwin'})│  │  {                              │
│                          │  │    "query": "meetings with Corwin"│
...
│     "Last meeting with Corwin was 'Q4 Planning' on Nov 25 at 2pm.  │
...
│                    Return to User                                │
│                                                                   │
│  "Your last meeting with Corwin was the 'Q4 Planning' session on   │
