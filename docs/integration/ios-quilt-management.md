...
```
     ...
     ┌─────────────────────────────────────────────────┐
     │  PROJECT: "Harborview Mutual transcription"           │
     │                                                  │
     │  ├── DECISION: "Use Nova 3"                      │
...
```json
{
  ...
  "facts": [
    {
      "patch_id": "aaa-111",
      "fact": "Harborview Mutual transcription project",
      "category": "project",
      "patch_type": "project",
      "project": null,
      "source": "inferred",
    ...
    {
      "patch_id": "aaa-333",
      "fact": "Use Nova 3 for Harborview Mutual transcription",
      "category": "decision",
      "patch_type": "decision",
      "project": "Harborview Mutual",
      "source": "inferred",
      "created_at": "2026-03-25T14:32:10Z",
      "connections": [
...
```
X-CQ-Matched: 3
X-CQ-Entities: Trevor,Harborview Mutual,Nova 3
```
...
→ [{"project_id": "...", "name": "Harborview Mutual", "status": "active", "patch_count": 9}]
```
